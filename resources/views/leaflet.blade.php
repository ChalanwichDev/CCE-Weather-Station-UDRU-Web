...
<body>
        <div id="mapid"></div>
        <script>
        var mymap = L.map('mapid').setView([17.4517878, 102.9339000], 12);
        L.tileLayer('https://api.maptiler.com/maps/streets/{z}/{x}/{y}.png?key=dycnfgHMQqrAQxG6UrtC', {
            attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
            maxZoom: 18
        }).addTo(mymap);
        var marker = L.marker([17.4517878,102.9339000]).addTo(mymap);
        marker.bindPopup('<i class="fa fa-circle w3-text-green w3-small" id="circle_PM10">&nbsp;<span p class="w3-text-green w3-large" id="msg1">--</p></span><br>'+
      '<i class="fa fa-circle w3-text-green w3-small" id="circle_Tem">&nbsp;<span p class="w3-text-green w3-large" id="msg3">--</p></span><br>'+
       ...
       '<i class="fa fa-circle w3-text-green w3-small" id="circle_UV">&nbsp;<span p class="w3-text-green w3-large" id="msg10">--</p></span>',{minWidth:250,maxWidth:350,maxHeight:190}).openPopup();
